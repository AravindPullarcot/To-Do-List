...
public class TodoController {
	...
	public TodoController(todolistService todolist) {
		super();
	...
	public String listall(ModelMap model) {
		...
		List<Todolist> todos = todolist.findByUsername(username);
	...
	public String addtodolist(ModelMap model,@Valid Todolist todo, BindingResult result /*@RequestParam String description instead of binding by mapping we can bind by Todolist*/ ) {
		...
		String username=getLoggedInUsername(model);;
		todolist.addtodo(username, /*description instead of description we can*/todo.getDescription(), todo.getTargetdate(), false);
